    ...
    <div className="py-14 min-h-[calc(100vh-100px)]">
      ...
      {isLoading ? (
        ...
        <div className="mt-5">
          ...
          {activeStep === 1 && <CheckoutPaymentMethod />}
          {activeStep === 2 && (
            <OrderSummary
      ...
      <div
        className="flex justify-center items-center px-4 fixed z-50 h-24 bottom-0 bg-white left-0 w-full py-4 border-slate-200"
